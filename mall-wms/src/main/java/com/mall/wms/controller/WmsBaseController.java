...
public class WmsBaseController {
    ...
    @PreAuthorize("@portalAuthorization.isPortal('warehouse-h5') or hasAuthority('wms:warehouse:view')")
    ...
    @GetMapping("/zones")
    @PreAuthorize("@portalAuthorization.isPortal('warehouse-h5') or hasAuthority('wms:zone:view')")
    ...
    @PreAuthorize("@portalAuthorization.isPortal('warehouse-h5') or hasAuthority('wms:location:view')")
    ...
    @GetMapping("/lines")
    @PreAuthorize("@portalAuthorization.isPortal('warehouse-h5') or hasAuthority('wms:line:view')")
    ...
    @PreAuthorize("@portalAuthorization.isPortal('warehouse-h5') or hasAuthority('wms:line-station:view')")
    ...
    @GetMapping("/drivers")
    @PreAuthorize("@portalAuthorization.isPortal('warehouse-h5') or hasAuthority('wms:driver:view')")
